...
class Ui_HomePageSU(object):
    ...
    def setupUi(self, HomePageSU):
        ...
        self.centralwidget = QtWidgets.QWidget(HomePageSU)
        ...
        HomePageSU.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(HomePageSU)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 978, 21))
        self.menubar.setObjectName("menubar")
        HomePageSU.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(HomePageSU)
        self.statusbar.setObjectName("statusbar")
        HomePageSU.setStatusBar(self.statusbar)
        self.actionProfile = QtWidgets.QAction(HomePageSU)
        self.actionProfile.setObjectName("actionProfile")
        self.actionInbox = QtWidgets.QAction(HomePageSU)
        self.actionInbox.setObjectName("actionInbox")
        self.actionGroups = QtWidgets.QAction(HomePageSU)
        ...
        self.pushButton_Groups.clicked.connect(HomePageSU.close)
        self.pushButton_Inbox.clicked.connect(self.openInboxPage)
        self.pushButton_Inbox.clicked.connect(HomePageSU.close)
    ...
    def retranslateUi(self, HomePageSU):
        ...
        HomePageSU.setWindowTitle(_translate("HomePageSU", "MainWindow"))
        self.label_AppName.setText(_translate("HomePageSU", "TeamUp"))
        self.pushButton_Search.setText(_translate("HomePageSU", "Search"))
        self.pushButton_Logout.setText(_translate("HomePageSU", "Logout"))
        self.pushButton_Groups.setText(_translate("HomePageSU", "Groups"))
        self.pushButton_Inbox.setText(_translate("HomePageSU", "Inbox"))
        self.pushButton_Profile.setText(_translate("HomePageSU", "Profile"))
        self.pushButton_SU.setText(_translate("HomePageSU", "SU"))
        self.label_User3ProjectDescription.setText(_translate("HomePageSU", "Project Description: After school tutoring \n"
"                                 Outdoor cleanup project\n"
"       "))
        self.label_User1Stat.setText(_translate("HomePageSU", "User Status: SU"))
        self.label_User2ID.setText(_translate("HomePageSU", "User ID: U016"))
        self.label_TopUsers.setText(_translate("HomePageSU", "Top Users:"))
        self.label_TopProjects.setText(_translate("HomePageSU", "Top Projects:"))
        self.label_User1Name.setText(_translate("HomePageSU", "Name: Wilma Mckenzie"))
        self.label_Project2Descrip.setText(_translate("HomePageSU", "Project Description: Cleaning parks and \n"
"                                nature reserves in the\n"
"                                  neighborhood.  \n"
" "))
        self.label_User1ID.setText(_translate("HomePageSU", "User ID: U005"))
        self.label_Project2Member.setText(_translate("HomePageSU", "Team Members: Stan Crossley, \n"
"                            Mercedes Cortes,\n"
"                           Wilma Mckenzie, \n"
"                           Nyah Villanueva  \n"
""))
        self.label_Project1Title.setText(_translate("HomePageSU", "Project Title: Pop up library"))
        self.label_User3Score.setText(_translate("HomePageSU", "Reputation Score: 16"))
        self.label_User2Stat.setText(_translate("HomePageSU", "User Status: VIP"))
        self.label_User3ID.setText(_translate("HomePageSU", "User ID: U067"))
        self.label_User2ProjectDescription.setText(_translate("HomePageSU", "Project Description: Book and toy drive \n"
"                                 Outdoor cleanup project\n"
"                                 Document life stories  \n"
" "))
        self.label_user1Score.setText(_translate("HomePageSU", "Reputation Score: 49"))
        self.label_Project2Title.setText(_translate("HomePageSU", "Project Title: Outdoor cleanup project"))
        self.label_User3Stat.setText(_translate("HomePageSU", "User Status: OU"))
        self.label_User2Name.setText(_translate("HomePageSU", "Name: Nyah Villanueva"))
        self.label_Project1Member.setText(_translate("HomePageSU", "Team Members: Rhyley Gamble, \n"
"                           Wilma Mckenzie,\n"
"                           Rabia Rossi, \n"
"                           Olive Sanderson  \n"
""))
        self.label_Project3Member.setText(_translate("HomePageSU", "Team Members: Waqas Stuart, \n"
"                           Tiya Adams,\n"
"                           Rabia Rossi, \n"
"                           Nyag Villanueva  \n"
""))
        self.label_Project3Descrip.setText(_translate("HomePageSU", "Project Description: Collect donations for \n"
"                                local schools and\n"
"                                  community centers.  \n"
" "))
        self.label_Project3ID.setText(_translate("HomePageSU", "Project ID: P007"))
        self.label_User2Score.setText(_translate("HomePageSU", "Reputation Score: 31"))
        self.label_Project1ID.setText(_translate("HomePageSU", "Project ID: P001"))
        self.label_Project3Title.setText(_translate("HomePageSU", "Project Title: Book and toy drive"))
        self.label_User1ProjectDescription.setText(_translate("HomePageSU", "Project Description: Pop-up library \n"
"                                 Outdoor cleanup project\n"
"                                 Document life stories  \n"
" "))
        self.label_Project1Descrip.setText(_translate("HomePageSU", "Project Description: Build a pop-up library \n"
"                                and invite the community\n"
"                                  to donate and take books.  \n"
" "))
        self.label_User3Name.setText(_translate("HomePageSU", "Name: Stan Crossley"))
        self.label_Project2ID.setText(_translate("HomePageSU", "Project ID: P004"))
        self.actionProfile.setText(_translate("HomePageSU", "Profile"))
        self.actionInbox.setText(_translate("HomePageSU", "Inbox"))
        self.actionGroups.setText(_translate("HomePageSU", "Groups"))
        self.actionSU_page.setText(_translate("HomePageSU", "SU page"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    HomePageSU = QtWidgets.QMainWindow()
    ui = Ui_HomePageSU()
